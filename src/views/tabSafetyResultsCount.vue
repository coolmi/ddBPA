        ...
        <div class="title_left">
          <table class="main_table">
            <tr v-for="(val,index) in list2" :key="index">
              ...
              <th style="width: 45px;font-size: 14px">{{val.zrs}}</th>
              <th style="width: 45px;font-size: 14px">{{val.wxsbrs}}</th>
        ...
        <div class="content_left">
          <table class="main_table">
            <tr v-for="(item,index) in list" :key="index">
              ...
              <td style="width: 45px;font-size: 14px">{{item.zrs}}</td>
              <td style="width: 45px;font-size: 14px">{{item.wxsb}}</td>
